...
echo ""
echo "í³š Project Structure:"
echo "   í³± frontend/    - React dashboard (Amharic/English)"
echo "   âš™ï¸  backend/     - Node.js API"
echo "   í´– ml-service/  - Python ML for Ethiopian threats"
echo "   í·„ï¸  db/         - PostgreSQL database"
echo "   í´§ scripts/     - Deployment & utilities"
echo ""
echo "í¼ BunaSIEM - Affordable Cybersecurity for Ethiopia í·ªï¿½ï¿½"
